/*
  ...
  - You are about to drop the column `variantAttributes` on the `products` table. All the data in the column will be lost.
...
INSERT INTO "new_products" ("acquisitionMethod", "averageCost", "barcode", "categoryId", "code", "createdAt", "createdBy", "defaultWarehouseId", "description", "id", "isActive", "isTemplate", "latestCost", "maxStock", "minStock", "model", "name", "qrCode", "remark", "reorderPoint", "safetyStock", "safetyStockMax", "safetyStockMin", "specification", "standardCost", "status", "type", "unitId", "updatedAt", "updatedBy", "version") SELECT "acquisitionMethod", "averageCost", "barcode", "categoryId", "code", "createdAt", "createdBy", "defaultWarehouseId", "description", "id", "isActive", "isTemplate", "latestCost", "maxStock", "minStock", "model", "name", "qrCode", "remark", "reorderPoint", "safetyStock", "safetyStockMax", "safetyStockMin", "specification", "standardCost", "status", "type", "unitId", "updatedAt", "updatedBy", "version" FROM "products";
DROP TABLE "products";
