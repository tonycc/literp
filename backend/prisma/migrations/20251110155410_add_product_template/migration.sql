...
CREATE TABLE "product_templates" (
    ...
    "category" TEXT,
    "type" TEXT NOT NULL,
    "variantAttributeIds" TEXT DEFAULT '[]',
...
CREATE TABLE "new_products" (
    ...
    CONSTRAINT "products_productTemplateId_fkey" FOREIGN KEY ("productTemplateId") REFERENCES "product_templates" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
